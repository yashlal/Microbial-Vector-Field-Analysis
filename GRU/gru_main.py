...
for z in range(ensemble_size):
   ...
   'dropout': 0.6}
    ...
    best_prediction, bpred_epoch, best_model, test_loss = gru_funcs.full_train(num_channels,hsize,layers,dropout,batch_size,LR,
...
gru_funcs.plot_best_fit(full_test_data, best_prediction, pred_color, base_data_color, best_fit_idx, blastT_labels, False, None, full_test_data)